public class Personagens {
    public String criarPersonagem(String personagem) {
        return """
                ...
                tijolos amarelos e decide segui-la. Quanto mais você avança, a estrada adentra uma floresta 
                escura e sombria.
                Ao fim da estrada, encontra uma porta que parece conter algum tipo de enigma para abri-la. De repente, uma 
                voz ecoa de dentro da floresta: “""" + personagem + """
                ! Estávamos empolgados em ver você por aqui. Que bom que você 
